...
public class MainController {
	...
	@Operation(summary = "메인 페이지 가져오기", description = "세션에 저장된 로그인 정보를 확인 후 그에 맞는 메인 페이지를 가져옵니다.")
	@GetMapping("")
	...
	@Operation(summary = "오늘의 영화 갱신", description = "@Scheduled 애너테이션을 이용하여 매일 자정에 오늘의 영화 테이블의 영화들을 갱신합니다.")
